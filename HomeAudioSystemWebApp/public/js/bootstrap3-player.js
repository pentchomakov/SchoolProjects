...
(function ($) {'use strict';
    $('audio[controls]').before(function () {
        ...
        $(data_sec).addClass('collapsing center-block2 row col-sm-12');

        var toggle_holder = document.createElement('div');
        $(toggle_holder).addClass('btn-group center-block2 row col-sm-12');
        ...
        $(player).addClass('btn-group  center-block2 row  col-sm-12');
